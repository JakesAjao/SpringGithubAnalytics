...
public class AbsenteeExcelExporter {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<MemberAttend> listUsers;

    public AbsenteeExcelExporter(List<MemberAttend> listUsers) {
    ...
    private void writeHeaderLine() {
        sheet = workbook.createSheet("MemberAttendance");
    ...
    private void writeDataLines() {
        ...
        for (MemberAttend user : listUsers) {
